...
public class MapCSP extends CSP {
    public static final Variable NSW = new Variable("NSW",1);
    public static final Variable NT = new Variable("NT",2);
    public static final Variable Q = new Variable("Q",3);
    public static final Variable SA = new Variable("SA",4);
    public static final Variable T = new Variable("T",5);
    public static final Variable V = new Variable("V",6);
    public static final Variable WA = new Variable("WA",7);
